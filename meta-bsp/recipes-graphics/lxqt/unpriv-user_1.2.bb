DESCRIPTION = "This recipe adds a user 'user' without password"
LICENSE = "MIT"
...
USERADD_PARAM_${PN} = "-m -c user -d /home/${USERNAME} -s /bin/bash -k /etc/skel -g ${USERNAME} --groups ${USERGROUPS} ${USERNAME}"
